...
//    }
//
//    public Dummy_scanner(String source) {
//        this.source = source;
//    }
//
...
//        if (t == INT) addToken(INT, Integer.parseInt(source.substring(start, current)));
//        else if (t == FLOAT) addToken(FLOAT, Float.parseFloat(source.substring(start, current)));
//    }
//
